...
namespace LetsCSharp.Constructors
{
    ...
    {
        static StaticExample() // no access specifiers allowed and will
                               // be called only once and shared by all objects
        {
            Helper.WriteLineWithTab("Static Constructor");
        }
        public StaticExample() : this(1) //Parameterised constructor will be called first
                                         //and then the default constructor
        {
